...
const appWhite = Color(0xffF9FCFF);
...
ThemeData themeDark = ThemeData(
  ...
  tabBarTheme: TabBarTheme(labelColor: appWhite, indicatorColor: appWhite),
  textSelectionTheme: TextSelectionThemeData(cursorColor: appWhite),
);
